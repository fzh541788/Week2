...
- (void)viewDidLoad {
    ...
    //通过一个子函数实现注册的功能
    [_tableView1 registerClass:[UpTableViewCell class] forCellReuseIdentifier:@"1"];
    [_tableView2 registerClass:[UpTableViewCell class] forCellReuseIdentifier:@"2"];
    [_tableView3 registerClass:[UpTableViewCell class] forCellReuseIdentifier:@"3"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(tableView.tag == 101){
        UpTableViewCell *cell1 = [_tableView1 dequeueReusableCellWithIdentifier:@"1" forIndexPath:indexPath];
     ...
     UpTableViewCell *cell2 = [_tableView2 dequeueReusableCellWithIdentifier:@"2" forIndexPath:indexPath];
       ...
       UpTableViewCell *cell3 = [_tableView3 dequeueReusableCellWithIdentifier:@"3" forIndexPath:indexPath];
